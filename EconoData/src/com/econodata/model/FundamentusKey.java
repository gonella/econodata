...
public enum FundamentusKey implements java.io.Serializable{
	...
	Preço_Lucro("BODY[0].DIV[0].DIV[1].TABLE[1].TBODY[0].TR[0].TD[3].SPAN[0].CONTENT[0]"),
	P_VP("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[2].TD[3].SPAN[0].CONTENT[0]"),
	P_EBIT("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[3].TD[3].SPAN[0].CONTENT[0]"),
	PSR("BODY[0].DIV[0].DIV[1].TABLE[1].TBODY[0].TR[1].TD[1].SPAN[0].CONTENT[0]"),
	Preço_Ativos("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[5].TD[3].SPAN[0].CONTENT[0]"),
	Preço_Capital_de_Giro("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[1].TD[3].SPAN[0].CONTENT[0]"),
	Preço_de_Ativo_Circulante_Liquido("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[7].TD[3].SPAN[0].CONTENT[0]"),
	Dividend_Yield("BODY[0].DIV[0].DIV[0].DIV[1].P[0].STRONG[0].CONTENT[0]"),
	EV_EBIT("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[9].TD[3].SPAN[0].CONTENT[0]"),
	Giro_Ativos("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[10].TD[3].SPAN[0].CONTENT[0]"),
	Crescimento_da_Receita_Liquida_no_Ultimos_5_Anos("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[1].TD[1].SPAN[0].FONT[0].CONTENT[0]"),
	
	LPA("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[1].TD[5].SPAN[0].CONTENT[0]"),
	VPA("BODY[0].DIV[0].DIV[1].TABLE[0].TBODY[0].TR[2].TD[3].SPAN[0].CONTENT[0]"),
	Margem_Bruta("BODY[0].DIV[0].DIV[1].TABLE[0].TBODY[0].TR[0].TD[3].SPAN[0].CONTENT[0]"),
	Margem_EBIT("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[4].TD[5].SPAN[0].CONTENT[0]"),
	Margem_Liquida("BODY[0].DIV[0].DIV[1].TABLE[1].TBODY[0].TR[1].TD[1].SPAN[0].CONTENT[0]"),
	EBIT_Ativo("BODY[0].DIV[0].DIV[1].TABLE[0].TBODY[0].TR[0].TD[3].SPAN[0].CONTENT[0]"),
	ROIC("BODY[0].DIV[0].DIV[1].TABLE[1].TBODY[0].TR[1].TD[3].SPAN[0].CONTENT[0]"),
	ROE("BODY[0].DIV[0].DIV[1].TABLE[0].TBODY[0].TR[1].TD[3].SPAN[0].CONTENT[0]"),
	Liquidez_Corrente("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[9].TD[5].SPAN[0].CONTENT[0]"),
	Divida_Bruta_Total_Divida_Pelo_Patrimonio("BODY[0].DIV[0].DIV[1].TABLE[2].TBODY[0].TR[10].TD[5].SPAN[0].CONTENT[0]"),
